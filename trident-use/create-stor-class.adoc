...
Astra Trident proporciona https://github.com/NetApp/trident/tree/master/trident-installer/sample-input/pvc-samples["definiciones simples de clase de almacenamiento para back-ends específicos"^].
