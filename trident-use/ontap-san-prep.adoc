...
--
'''
Versión: 1 backendName: ExampleBackend storageDriverName: ontap-san managementLIF: 10.0.0.1 dataLIF: 10.0.0.2 svm: svm_nfs username: Vsadmin password: Password
