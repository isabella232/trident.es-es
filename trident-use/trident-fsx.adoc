...
Usos de Amazon FSX para ONTAP de NetApp https://["FabricPool"^] para gestionar los niveles de almacenamiento. Le permite almacenar datos en un nivel, según la frecuencia de acceso a estos.
...
* https://["Documentación de Amazon FSX para ONTAP de NetApp"^]
* https://["Publicación del blog en Amazon FSX para ONTAP de NetApp"^]
