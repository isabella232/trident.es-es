...
Para obtener más información sobre el controlador, consulte link:../trident-use/ontap-nas.html.html["Controladores de NAS"] y.. link:../trident-use/ontap-san.html.html["Controladores de SAN"].
