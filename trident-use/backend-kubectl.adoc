...
----
También puede echar un vistazo a los ejemplos de la https://["instalador de trident"^] directorio para configuraciones de ejemplo para la plataforma o servicio de almacenamiento que desee.
...
. Cree un https://["Secreto Kubernetes"^]. El secreto contiene las credenciales que Astra Trident necesita para comunicarse con el clúster/servicio de almacenamiento.
