...
NOTE: Asegúrese de seguir los pasos de preparación de nodos necesarios para Amazon Linux y Ubuntu https://["Imágenes de máquina de Amazon"^] (AMI) en función del tipo de IAM EKS.
