...
Puede actualizar un desde una instalación de operadores Trident en el ámbito del clúster a otra instalación del operador Trident en el ámbito del clúster. Todas las versiones 21.01 y posteriores de Astra Trident utilizan un operador con ámbito de clúster.
...
. Instale Astra Trident con el archivo YAML de paquete correcto para su entorno y la versión Astra Trident. Por ejemplo, si va a instalar Astra Trident 23,07 para Kubernetes 1,27, ejecute el siguiente comando:
. Instale Astra Trident con el archivo YAML de paquete correcto para su entorno y la versión Astra Trident. Por ejemplo, si va a instalar Astra Trident 23,07 para Kubernetes 1,27, ejecute el siguiente comando:
+
[listing]
----
...
. Utilice la `helm upgrade` comando donde `trident-operator-23.07.0.tgz` refleja la versión a la que desea actualizar.
+
[listing]
----
