...
No tiene ninguna preferencia entre tener una LIF de gestión dedicada o compartida para la SVM, sin embargo, debe asegurarse de que las políticas de seguridad de red se alineen con el enfoque que elija. Sin embargo, debería accederse a la LIF de gestión a través de DNS para facilitar la máxima flexibilidad que debería tener https://["SVM-DR"^] Se podrá usar en combinación con Trident.



=== Limite el número máximo de volúmenes

Los sistemas de almacenamiento de ONTAP tienen un número máximo de volúmenes, que varía en función de la versión del software y la plataforma de hardware. Consulte https://["Hardware Universe de NetApp"^] Para su plataforma y versión de ONTAP específica, determine los límites exactos. Cuando se agota el número de volúmenes, las operaciones de aprovisionamiento fallan no solo para Trident, sino para todas las solicitudes de almacenamiento.
...
Al aprovechar una política de calidad de servicio de ONTAP, aplicada a la SVM, se limita el número de IOPS consumibles por los volúmenes aprovisionados de Trident. Esto ayuda a. http://["prevenir un matón"^] O un contenedor fuera de control que no afecta a las cargas de trabajo fuera de la SVM de Trident.
...
La calidad de servicio garantiza que el rendimiento de las cargas de trabajo críticas no se vea degradado por cargas de trabajo de la competencia. Los grupos de políticas de calidad de servicio de ONTAP proporcionan opciones de calidad de servicio para volúmenes y permiten a los usuarios definir el techo de rendimiento para una o más cargas de trabajo. Para obtener más información sobre la calidad de servicio, consulte https://["Rendimiento garantizado con QoS"^]. Puede especificar grupos de políticas de calidad de servicio en el back-end o en un pool de almacenamiento y se aplican a cada volumen creado en ese pool o back-end.
...
Para obtener más información sobre los grupos de políticas de calidad de servicio, consulte https://["Comandos de calidad de servicio de ONTAP 9.8"^].
...
A continuación se enumeran algunas de las prácticas recomendadas. Busque en el https://["Biblioteca de NetApp"^] para las versiones más actuales.

*ONTAP*

* https://["Prácticas recomendadas y guía de implementación de NFS"^]
* http://["Guía de administración de SAN"^] (Para iSCSI)
* http://["Configuración exprés de iSCSI para RHEL"^]


*Software Element*

* https://["Configuración de SolidFire para Linux"^]


*NetApp HCI*

* https://["Requisitos previos de la implementación de NetApp HCI"^]
* https://["Acceda al motor de implementación de NetApp"^]


*Información sobre las prácticas recomendadas de la aplicación*

* https://["Prácticas recomendadas para MySQL en ONTAP"^]
* https://["Prácticas recomendadas para MySQL en SolidFire"^]
* http://["NetApp SolidFire y Cassandra"^]
* http://["Prácticas recomendadas de Oracle en SolidFire"^]
* http://["Prácticas recomendadas de PostgreSQL en SolidFire"^]


No todas las aplicaciones tienen directrices específicas, es importante trabajar con su equipo de NetApp y utilizar el https://["Biblioteca de NetApp"^] para encontrar la documentación más actualizada.
