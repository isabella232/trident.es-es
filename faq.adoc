...
A partir del lanzamiento de la versión 24,02, Astra Trident se lanza cada cuatro meses: Febrero, junio y octubre. Este es un mes después de un lanzamiento de Kubernetes.
