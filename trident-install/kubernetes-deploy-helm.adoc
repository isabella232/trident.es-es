...
----
. Uso `helm install` y especifique un nombre para la implementación como en el ejemplo siguiente donde `23.07.0` Es la versión de Astra Trident que está instalando.
+
[listing]
----
