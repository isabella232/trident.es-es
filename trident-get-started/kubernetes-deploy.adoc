...
Si tiene una puesta en marcha existente que debe actualizarse o si desea personalizar altamente su puesta en marcha, debe tener en cuenta link:kubernetes-deploy-tridentctl.html["instalación mediante trimentctl"]. Este es el método convencional de puesta en marcha de Astra Trident.
