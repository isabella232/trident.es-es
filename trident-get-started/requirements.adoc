...
[%collapsible%open]
====
* Kubernetes 1,30 ahora es compatible con Astra Trident. Actualiza Astra Trident antes de actualizar Kubernetes.
...
| v1.24.0, v1.25.0, v1.26.0, v1.27.0, v1.28.0, v1.29.0 y v1.30.0  a| 
